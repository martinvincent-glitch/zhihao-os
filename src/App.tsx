...
const RacingGame = () => {
  ...
  const gameLoop = () => {
    ...
    // 強制讓 Canvas 寬度等於容器寬度，高度則根據螢幕調整
    const containerWidth = canvas.parentElement?.clientWidth || window.innerWidth;
    canvas.width = containerWidth;
    canvas.height = window.innerWidth < 768 ? 450 : (canvas.parentElement?.clientHeight || 600);
          ...
          <div className="relative z-10">
             ...
             {!decrypted ? (
                 ...
                 <div className="space-y-6 text-gray-300 leading-relaxed font-sans animate-[fadeIn_1s_ease-out]">
                    ...
                    <p>
                        <span className="text-green-500 font-mono">{`>>>`}</span> 感謝你在我每次北上的時候擔任最強 <strong className="text-white">桃園在地嚮導</strong>，都撥出時間熱心招待。博士忙碌之餘也別忘了好好充電休息。
                    </p>
